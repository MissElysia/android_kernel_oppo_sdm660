...
#endif
ifeq ($(OPPO_TARGET_DEVICE),MSM_16051 MSM_16052)
  CFLAGS_KERNEL += -DIS_PROJECT_16051
endif
ifeq ($(OPPO_TARGET_DEVICE),MSM_17011 MSM_17013)
  CFLAGS_KERNEL += -DIS_PROJECT_17011
endif
ifeq ($(OPPO_TARGET_DEVICE),MSM_16103)
  CFLAGS_KERNEL += -DIS_PROJECT_16103
endif
ifeq ($(OPPO_TARGET_DEVICE),MSM_16118 MSM_16116)
  CFLAGS_KERNEL += -DIS_PROJECT_16118
endif
ifeq ($(OPPO_TARGET_DEVICE),MSM_17021 MSM_17023)
